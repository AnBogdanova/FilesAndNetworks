...
public class RouteCalculatorTest extends TestCase {
    ...
    public void setUp() throws Exception {
        ...
        Station teplichnaya = new Station("Тепличная", line3);
        Station ogorodnaya = new Station("Огородная", line3);

        Stream.of(line1, line2, line3).forEach(stationIndex::addLine);
        Stream
                .of(moskovskaya, kyrskaya, omskaya, ozernaya, zaprudnaya, morskaya, sadovaya, teplichnaya,
        ...
        threeTransfersRoute = Stream
                .of(moskovskaya, kyrskaya, zaprudnaya, morskaya, ogorodnaya, teplichnaya, sadovaya)
                .collect(Collectors.toList());
    }
